LEXICON_EN: dict[str,str] = {
    ...
    'improssive projucts on Tulegrum!'
    '————————————————'
    'Want to get even more $GRUM ?  Just bring a friend, or better all of your friends! Send an invite - once'
    'a friend launches the bot and fulfils all the conditions, you ll get 50 $GRUM!'
    'You will get bonus for every friend!'
    '————————————————'
    '🤝Your referral link: *уникальная реферальная ссылка*👨‍👩‍👧‍👦 Number of referrals: 0Your balance: 0.00750000 TON 💎'
